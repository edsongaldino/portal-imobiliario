    ...
    <div class="container-fluid p0">
        ...
        <nav>
            ...
            <ul id="respMenu" class="ace-responsive-menu text-right" data-menu-style="horizontal">
                <li class="list-inline-item add_listing"><a href="{{ url("/painel/anuncios/incluir") }}"><span class="flaticon-plus"></span><span class="dn-lg"> Incluir Anúncio</span></a></li>
            </ul>
        </nav>
    </div>
</header>
...
<div id="page" class="stylehome1 h0">
    ...
    <nav id="menu" class="stylehome1">
        <ul>
            ...
            <li class="treeview"><a href="{{ url("/dashboard") }}"><i class="flaticon-envelope"></i><span> Contatos (Leads)</span></a></li>
            ...
            <li><a href="{{ url("/dashboard") }}"><i class="flaticon-user"></i> <span>Meu Perfil</span></a></li>
            <li><a href="{{ url("/dashboard") }}"><i class="flaticon-logout"></i> <span>Sair</span></a></li>
...
<div class="dashboard_sidebar_menu dn-992">
    <ul class="sidebar-menu">
        ...
        <li class="treeview">
            <a href="{{ url("/dashboard") }}"><i class="flaticon-share"></i><span> Integrações</span><i class="fa fa-angle-down pull-right"></i></a>
            <ul class="treeview-menu">
                <li><a href="#"><i class="fa fa-circle"></i> Relatório Geral</a></li>
                <li><a href="#"><i class="fa fa-circle"></i> Erros</a></li>
            </ul>
        </li>
