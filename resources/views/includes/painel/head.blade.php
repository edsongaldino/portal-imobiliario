...
<link rel="stylesheet" href="{{ asset('assets/portal/css/dashbord_navitaion.css') }}">
<!-- Responsive stylesheet -->
<link rel="stylesheet" href="{{ asset('assets/portal/css/responsive.css') }}">
<link rel="stylesheet" href="{{ asset('assets/painel/css/custom.css') }}">
<!-- Title -->
<title>Painel Administrativo - Rede Imóveis</title>
<!-- Favicon -->
