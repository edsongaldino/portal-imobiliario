					...
					<tr>
						<td>
							<div class="text" style="padding: 0 2.5em; text-align: center;">
								...
								<h2>Olá {{ $anuncio->anunciante->nome ?? '' }}, </h2>
								<h2>Um novo lead foi gerado pelo portal Rede Imóveis, veja abaixo as informações:</h2>
                ...
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                  <tr>
                    <td style="text-align: left; padding-right: 10px;">
                        <h3 class="heading">Rede Imóveis MT</h3>
                        <p>Plataforma imobiliária</p>
                    </td>
                  </tr>
                </table>
              </td>
                ...
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                  <tr>
                    <td style="text-align: left; padding-left: 5px; padding-right: 5px;">
                        ...
                        <ul>
                          <li><span class="text">Cuiabá - MT</span></li>
                          <li><span class="text">(65) 99999-9999</span></a></li>
                      </ul>
                    </td>
                  </tr>
                </table>
